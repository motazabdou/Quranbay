        ...
        allSurahs.forEach((surah,index) => {
            surah.addEventListener("click", function(){
                ...
                .then(data => {
                    console.log(data);
                    console.log(index+1);
                    let verses = data.reciters[106].Server + "/00" + (index+1) + ".mp3";
                    if(index > 8 && index < 98){
                      verses = data.reciters[106].Server + "/0" + (index+1) + ".mp3";
                    }
                    else if(index > 98){
                        verses = data.reciters[106].Server + "/" + (index+1) + ".mp3";
                      }
                    audio.src = verses;
                    ...
                    audio.addEventListener("ended", function(){
                        ...
                        verses = data.reciters[106].Server + "/00" + (index+1) + ".mp3";
                        if(index > 8 && index < 98){
                        verses = data.reciters[106].Server + "/0" + (index+1) + ".mp3";
                        }
                        else if(index > 98){
